...
function mecm(
    ...
    for k in 0:19
        ...
        for m in 1:3
            ...
            eΣ1 = eigen(preΣ1)
            newΣ1unscaled = eΣ1.vectors * diagm(max.(eΣ1.values, 1e-06)) * eΣ1.vectors'
            ...
            eΣ2 = eigen(preΣ2)
            Σ2 = eΣ2.vectors * diagm(max.(eΣ2.values, 1e-06)) * eΣ2.vectors'
            # newΣ2 += etaS * ∇newΣ2
    ...
    for s in 1:maxiter
        ...
        preΣ1 = Σ1 + etaS * ∇Σ1
        eΣ1 = eigen(preΣ1)
        Σ1unscaled = eΣ1.vectors * diagm(max.(eΣ1.values, 1e-06)) * eΣ1.vectors'
